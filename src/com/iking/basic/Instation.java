...
import com.iking.beans.*;
import com.iking.tools.Tool;

@SuppressWarnings("unchecked")
public class Instation extends BasicServer implements ApplicationListener {
	...
	public void initBmxx() {
		...
		for (Bmxx bmxx : bmxxs)
			Tool.BM.put(bmxx.getSfzh() + bmxx.getZyzs().getZsmc()+bmxx.getZyzs().getZsdj(),
					bmxx.getBmid());
